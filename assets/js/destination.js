let destinationList = [
    {tagId:"bali",name: "Bali", duration: "3 Days 2 Nights",price:"Rp 1.560.000 / Orang" ,description: "Paket Tour Bali 3 hari 2 malam dengan Fasilitas Hotel Bintang 3. Mengunjungi wisata Penglipuran, Kintamani, Alas Arum Ubud, Pantai Kuta, Pantai Tanjung Benoa, Pantai Melasti, Pura Uluwatu, Pantai Jimbaran, Joger Shop, Krisna Oleh-oleh dan Beach Walk Mall"},
    {tagId:"yogya",name: "Yogyakarta", duration: "4 Days 3 Nights",price:"Rp 3.250.000 / Orang" ,description: "Paket Tour Yogyakarta 4 hari 3 malam dengan Fasilitas Hotel Bintang 3. Mengunjungi wisata Borobudur, Museum Merapi, Jepp Lava Tour, Goa Pindul, Rafting Sungai Oya, Pantai Kukup, Heha Sky View, Candi Prambanan, Jurang Tebelan, Rumah Hobit, Hutan Pinus Mangunan, Benteng Vredeburg, Keraton Yogyakarta, Malioboro dan Toko oleh-oleh"},
    {tagId:"bandung",name: "Bandung", duration: "5 Days 4 Nights",price:"Rp 3.750.000 / Orang" ,description: "Paket Tour Bandung 5 hari 4 malam dengan Fasilitas Hotel Bintang 4. Mengunjungi wisata Lembang Park&Zoo, Tangkuban Perahu, Sari ater Host spring Water, Orchid Forest Lembang, Floating Market Lembang, Farmhouse Lembang, Trans Studio Bandung, Kawah Putih, Ranca Upas, Perkebunan Teh Rancabali, Glamping lakeside Situ Patenggang"}
]
